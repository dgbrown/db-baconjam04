package org.flixel
{
	...
	public class FlxTilemap extends FlxObject
	{
		 ...
		 */
		public function findPath(Start:FlxPoint,End:FlxPoint,Simplify:Boolean=true,AllowDiagonals:Boolean=true,RaySimplify:Boolean=false):FlxPath
		{
			...
			var distances:Array = computePathDistance(startIndex,endIndex,AllowDiagonals);
			if(distances == null)
				return null;
		 ...
		 */
		protected function computePathDistance(StartIndex:uint, EndIndex:uint, AllowDiagonals:Boolean = true ):Array
		{
